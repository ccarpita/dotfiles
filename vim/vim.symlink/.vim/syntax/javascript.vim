...
syn region  javaScriptComment	       start="/\*"  end="\*/" contains=@Pod,javaScriptCommentTodo
...
if exists("javaScript_fold")
    ...
    syn region	javaScriptFunctionFold	start="\<function\>.*$" end="^.*[}].*$" transparent fold keepend 
