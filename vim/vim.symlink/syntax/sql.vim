...
syn keyword sqlKeyword	primary key
...
syn keyword sqlStatement nextval currval max min count sum

syn keyword sqlType	boolean char character date float integer long text varchar
syn keyword sqlType	mlslabel number raw rowid varchar varchar2 varray numeric timestamp
syn keyword sqlType	serial
