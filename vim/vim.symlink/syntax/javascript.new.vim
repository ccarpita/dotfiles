...
hi def link jsColonLHS                  Keyword
...
hi def link jsVarInBinding              Keyword

hi def link jsVarBindingKeyword         Type
hi def link jsVarBindingConstruct       Type
hi def link jsBindingConstruct          Special
hi def link jsBindingKeyword            Keyword
"hi def link jsBindingAssignment         Identifier
...
"hi def link jsDot                       Type
hi def link jsBuiltinType               Type
hi def link jsBuiltinLiteral            Type
hi def link jsBuiltinValue              Type
